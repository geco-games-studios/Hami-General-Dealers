...
export const blogPosts: BlogPost[] = [
  ...
  {
    id: '3',
    title: 'Quality Service and Agent Satisfaction',
    excerpt: 'Hami General Dealers operates in a competitive market by placing high value on quality service, reliable delivery, and agent satisfaction.',
    ...
    date: '2026-06-25',
    category: 'Technology',
    slug: 'quality-service-agent-satisfaction',
  },
  {
    id: '4',
  ...
  },
  {
    ...
    excerpt: 'We aim to offer agents world-class service, fair pricing, and strong belief in the products, equipment, and services we provide.',
...
export const subOrganizations = {
  ...
  mifi: {
    name: 'Mifi Goods and Supply',
    tagline: 'Goods and Supply',
    description: 'Mifi sources and supplies practical goods for agents, businesses, and communities.',
    mission: 'To provide dependable goods and supply support with practical agent service.',
    services: [
      'Goods supply',
      'Product sourcing',
...
export const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    role: 'Marketeer',
    company: 'Zambia',
    quote: 'The team values quality service and agent satisfaction, which makes them a practical supply partner.',
